export function OpenClawLogo({ width = "100%", height = "100%" }: { width?: string | number; height?: string | number }) {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
      <defs>
